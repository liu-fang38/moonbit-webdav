...
_M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid.prototype.$tag = 0;
...
function _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE2Ok.prototype.$tag = 1;
function _M0TP211localreview6webdav4Node(param0, param1, param2, param3) {
  this.ns = param0;
  this.name = param1;
  this.text = param2;
...
function _M0TP211localreview6webdav3Xml(param0, param1, param2) {
  this.cs = param0;
  this.i = param1;
  this.nodes = param2;
}
...
function _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(self, value) {
...
function _M0MPB4Iter9to__arrayGRPC16string10StringViewE(self) {
  ...
  while (true) {
    ...
    if (_bind$2 === undefined) {
      ...
      const _Some = _bind$2;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(result, _x);
      continue;
    }
  }
  return result;
...
function _M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(self) {
...
function _M0MPC15array5Array3popGRPC14json10WriteFrameE(self) {
  if (_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(self)) {
    return undefined;
  } else {
...
function _M0MPC15array5Array2atGRP211localreview6webdav4NodeE(self, index) {
  const len = self.length;
  return index >= 0 && index < len ? self[index] : $panic();
}
...
function _M0MPC15array5Array6filterGRP211localreview6webdav4NodeE(self, f) {
  const arr = [];
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MPC15array5Array10push__iterGsE(self, iter) {
  ...
  while (true) {
    ...
    if (_bind$2 === undefined) {
      ...
      const _Some = _bind$2;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(self, _x);
      continue;
    }
  }
}
...
function _M0MPC15debug4Repr6record(fields) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _name = _x._0;
      const _value = _x._1;
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_acc, new _M0DTPC15debug4Repr11RecordField(_name, _value));
      continue;
    }
  }
...
function _M0FPC15debug15surround__lines(start, finish, lines) {
  if (lines.length === 0) {
    ...
    if (lines.length === 1) {
      ...
      const _self = [];
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, `${start}${_first}`);
      _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array9ArrayView4iterGsE(_x));
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, `${_last}${finish}`);
      return _self;
    }
  }
}
      ...
      if (_first === "[" && _last === "]" || _first === "{" && _last === "}") {
        ...
        while (true) {
          ...
          if (_ < _bind) {
            ...
            if (_M0IP016_24default__implPB2Eq10not__equalGRPC16string10StringViewE(t, new _M0TPC16string10StringView(_M0FPC15debug14compact__linesN7_2abindS1134, 0, _M0FPC15debug14compact__linesN7_2abindS1134.length))) {
              _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(parts, t);
            }
            _tmp = _ + 1 | 0;
            continue;
          } else {
        ...
        if (_M0MPC16string6String11has__suffix(_first, new _M0TPC16string10StringView(_M0FPC15debug14compact__linesN7_2abindS1148, 0, _M0FPC15debug14compact__linesN7_2abindS1148.length)) && _last === ")") {
          ...
          while (true) {
            ...
            if (_ < _bind) {
              const m = lines[1 + _ | 0];
              _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(parts, _M0MPC16string6String4trim(m, undefined));
              _tmp = _ + 1 | 0;
              continue;
            } else {
              break;
          ...
          _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(parts, _M0MPC16string6String4trim(_last, undefined));
  ...
  if (contents.length === 0) {
    ...
    if (contents.length === 1) {
      ...
      if (_item.length > 1) {
        ...
        if (!_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(lines)) {
          const last_i = lines.length - 1 | 0;
          _M0MPC15array5Array3setGsE(lines, last_i, `${_M0MPC15array5Array2atGRP211localreview6webdav4NodeE(lines, last_i)},`);
        }
        const _self = [];
        _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, open);
        _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array5Array4iterGsE(lines));
        _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, close);
        return _self;
      } else {
        ...
        if (_ < _bind) {
          ...
          if (item_lines.length === 0) {
            ...
            if (item_lines.length === 1) {
              ...
              _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${_x},`);
            } else {
              const _first = item_lines[0];
              const _last = item_lines[item_lines.length - 1 | 0];
              const _x_end = item_lines.length - 1 | 0;
              _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${_first}`);
              ...
              while (true) {
                ...
                if (_$2 < _bind$2) {
                  ...
                  _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${mid}`);
                  _tmp$2 = _$2 + 1 | 0;
                  continue;
                } else {
                  break;
              ...
              _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${_last},`);
            }
          }
          _tmp = _ + 1 | 0;
          continue;
      ...
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, close);
      return out;
    }
  }
}
          ...
          if (contents.length === 1) {
            ...
            if (item_lines.length === 0) {
              ...
              if (item_lines.length === 1) {
                ...
                const _self = [];
                _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, begin);
                ...
                _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, `${_M0MPC16string6String6repeat(" ", 2)}${_last_line},`);
                _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, end);
                return _self;
              }
            }
          } else {
            ...
            while (true) {
              ...
              if (_ < _bind) {
                ...
                if (item_lines.length === 0) {
                  ...
                  if (item_lines.length === 1) {
                    const _x = item_lines[0];
                    _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", 2)}${_x},`);
                  } else {
                    const _first = item_lines[0];
                    const _last = item_lines[item_lines.length - 1 | 0];
                    const _x_end = item_lines.length - 1 | 0;
                    _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", 2)}${_first}`);
                    const _bind$2 = _x_end - 1 | 0;
                    let _tmp$2 = 0;
                    while (true) {
                      const _$2 = _tmp$2;
                      if (_$2 < _bind$2) {
                        const mid = item_lines[1 + _$2 | 0];
                        _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", 2)}${mid}`);
                        _tmp$2 = _$2 + 1 | 0;
                        continue;
                      } else {
                        break;
                    ...
                    _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, `${_M0MPC16string6String6repeat(" ", 2)}${_last},`);
                  }
                }
                _tmp = _ + 1 | 0;
                continue;
            ...
            _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, end);
            return out;
          }
        }
      }
...
function _M0MPC15debug4Repr19prune__info_2einnerN2goS259(replacement, d, node) {
  ...
  if (d <= 0) {
    return _M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(children) ? node : !_M0MPC15debug4Repr17info__adds__depth(node) ? _M0MPC15debug4Repr14with__children(node, _M0MPC15array5Array3mapGRPC15debug4ReprRPC15debug4ReprE(children, (child) => _M0MPC15debug4Repr19prune__info_2einnerN2goS259(replacement, d, child))) : replacement;
  } else {
    if (_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(children)) {
      return node;
    } else {
      ...
      if (children.length === 2) {
        ...
        if (_bind.length === 0) {
          ...
          if (_bind.length === 1) {
            ...
            const _self = [];
            _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, head);
      ...
      if (children.length === 1) {
        ...
        if (_bind.length === 0) {
          ...
          if (_bind.length === 1) {
            ...
            const _self = [];
            _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, `${_name$3}=${_first}`);
            _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array9ArrayView4iterGsE(_x$6));
            return _M0FPC15debug10no__parens(_M0FPC15debug15content__parens(_tmp$2, _self));
          }
        }
      ...
      if (children.length === 1) {
        ...
        if (_bind.length === 0) {
          ...
          if (_bind.length === 1) {
            ...
            const _self = [];
            _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(_self, `${label}: ${_first}`);
            _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array9ArrayView4iterGsE(_x$6));
            return _M0FPC15debug10no__parens(_M0FPC15debug15content__parens(_tmp$2, _self));
          }
        }
...
function _M0FPC14json13write__indent(buf, cache, level, indent) {
  while (true) {
    if (cache.length <= level) {
      if (cache.length >= 1) {
        ...
        _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(cache, `${_last}${_M0MPC16string6String6repeat(" ", indent)}`);
      } else {
        _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(cache, "\n");
      }
      continue;
    } else {
      break;
  ...
  _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0MPC15array5Array2atGRP211localreview6webdav4NodeE(cache, level));
}
    ...
    if (x === undefined) {
      if (stack.length === 0) {
        ...
        if (_x.$tag === 0) {
          ...
          const _i = _Array._1;
          if (_i < _arr.length) {
            const element = _M0MPC15array5Array2atGRP211localreview6webdav4NodeE(_arr, _i);
            _Array._1 = _i + 1 | 0;
            if (_i > 0) {
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_M0MPB3Map9is__emptyGsRPB4JsonE(_members)) {
            ...
            _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsRPB4JsonE(_members), true));
          }
          break;
        }
        case 5: {
          const _Array = _value;
          const _arr = _Array._0;
          if (_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(_arr)) {
            _M0IPB13StringBuilderPB6Logger13write__string(buf, "[]");
          } else {
            depth = depth + 1 | 0;
            ...
            _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
...
function _M0IP211localreview6webdav8ResourcePC15debug5Debug8to__repr(_x_107) {
  const _bind = [{ _0: "href", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_107.href) }, { _0: "status", _1: _M0IPC16option6OptionPC15debug5Debug8to__reprGiE(_x_107.status) }, { _0: "properties", _1: _M0IPC15array5ArrayPC15debug5Debug8to__reprGRP211localreview6webdav8PropertyE(_x_107.properties) }];
...
function _M0IP211localreview6webdav8ResourcePB6ToJson8to__json(_x_99) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "href", _M0IPC16string6StringPB6ToJson8to__json(_x_99.href));
  let $36$inner;
  _L: {
    _L$2: {
      const _bind$2 = _x_99.status;
      if (_bind$2 === undefined) {
      } else {
        const _Some = _bind$2;
  ...
  _M0MPB3Map3setGsRPB4JsonE($36$map, "properties", _M0IPC15array5ArrayPB6ToJson8to__jsonGRP211localreview6webdav8PropertyE(_x_99.properties));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP211localreview6webdav8DavErrorPC15debug5Debug8to__repr(_x_95) {
  let _arg_96;
  _L: {
    const _Invalid = _x_95;
    const _$42$arg_96 = _Invalid._0;
    _arg_96 = _$42$arg_96;
    break _L;
  }
  return _M0MPC15debug4Repr4ctor("Invalid", [{ _0: undefined, _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_arg_96) }]);
}
function _M0IP211localreview6webdav8PropertyPC15debug5Debug8to__repr(_x_93) {
  const _bind = [{ _0: "uri", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_93.uri) }, { _0: "name", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_93.name) }, { _0: "value", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_93.value) }, { _0: "status", _1: _M0IPC13int3IntPC15debug5Debug8to__repr(_x_93.status) }];
...
function _M0IP211localreview6webdav8PropertyPB6ToJson8to__json(_x_86) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "uri", _M0IPC16string6StringPB6ToJson8to__json(_x_86.uri));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "name", _M0IPC16string6StringPB6ToJson8to__json(_x_86.name));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "value", _M0IPC16string6StringPB6ToJson8to__json(_x_86.value));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "status", _M0IPC13int3IntPB6ToJson8to__json(_x_86.status));
  return _M0MPC14json4Json6object($36$map);
}
function _M0IP211localreview6webdav7RequestPB6ToJson8to__json(_x_77) {
  const _bind = [];
  const $36$map = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0), undefined);
  _M0MPB3Map3setGsRPB4JsonE($36$map, "verb", _M0IPC16string6StringPB6ToJson8to__json(_x_77.verb));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "target", _M0IPC16string6StringPB6ToJson8to__json(_x_77.target));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "headers", _M0IPB3MapPB6ToJson8to__jsonGssE(_x_77.headers));
  _M0MPB3Map3setGsRPB4JsonE($36$map, "body", _M0IPC16string6StringPB6ToJson8to__json(_x_77.body));
  return _M0MPC14json4Json6object($36$map);
}
...
function _M0FP211localreview6webdav8propfind(raw_path, depth, properties) {
  ...
  if (_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(properties)) {
...
function _M0MP211localreview6webdav3Xml5space(self) {
  while (true) {
...
function _M0MP211localreview6webdav3Xml4need(self, c) {
  if (self.i >= self.cs.length || _M0MPC15array5Array2atGcE(self.cs, self.i) !== c) {
    return new _M0DTPC16result6ResultGuRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("malformed XML"));
  }
  self.i = self.i + 1 | 0;
  return new _M0DTPC16result6ResultGuRP211localreview6webdav8DavErrorE2Ok(undefined);
}
function _M0MP211localreview6webdav3Xml4name(self) {
  const s = new _M0TPB8MutLocalGsE("");
  while (true) {
    if (self.i < self.cs.length) {
      const c = _M0MPC15array5Array2atGcE(self.cs, self.i);
      if (c >= 97 && c <= 122 || (c >= 65 && c <= 90 || (c >= 48 && c <= 57 || (c === 58 || (c === 95 || (c === 45 || c === 46)))))) {
        s.val = `${s.val}${_M0IPC14char4CharPB4Show10to__string(c)}`;
        self.i = self.i + 1 | 0;
      } else {
        break;
      }
  ...
  if (_M0MPC16string6String9is__empty(s.val)) {
  ...
  return new _M0DTPC16result6ResultGsRP211localreview6webdav8DavErrorE2Ok(s.val);
}
function _M0FP211localreview6webdav6entity(s) {
  ...
  while (true) {
    if (i.val < cs.length) {
      if (_M0MPC15array5Array2atGcE(cs, i.val) !== 38) {
        out.val = `${out.val}${_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(cs, i.val))}`;
        i.val = i.val + 1 | 0;
        continue;
      }
      i.val = i.val + 1 | 0;
      const name = new _M0TPB8MutLocalGsE("");
      while (true) {
        if (i.val < cs.length && _M0MPC15array5Array2atGcE(cs, i.val) !== 59) {
          name.val = `${name.val}${_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(cs, i.val))}`;
          i.val = i.val + 1 | 0;
          continue;
        } else {
          break;
      ...
      if (i.val >= cs.length) {
        return new _M0DTPC16result6ResultGsRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("entity terminator"));
      }
      i.val = i.val + 1 | 0;
      const _tmp = out.val;
      const _bind = name.val;
      let _tmp$2;
      switch (_bind) {
        case "amp": {
          _tmp$2 = "&";
        ...
        default: {
          return new _M0DTPC16result6ResultGsRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("unsupported entity"));
        }
      }
      out.val = `${_tmp}${_tmp$2}`;
      continue;
...
function _M0MP211localreview6webdav3Xml7element(self, inherited, depth) {
  self.nodes = self.nodes + 1 | 0;
  if (depth > 32 || self.nodes > 10000) {
    return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("XML resource limit"));
  }
  const _bind = _M0MP211localreview6webdav3Xml4need(self, 60);
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _ok._0;
  } else {
  ...
  const _bind$2 = _M0MP211localreview6webdav3Xml4name(self);
  let qname;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    qname = _ok._0;
  ...
  while (true) {
    _M0MP211localreview6webdav3Xml5space(self);
    if (self.i >= self.cs.length) {
      return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("truncated tag"));
    }
    if (_M0MPC15array5Array2atGcE(self.cs, self.i) === 47 || _M0MPC15array5Array2atGcE(self.cs, self.i) === 62) {
      break;
    }
    const _bind$3 = _M0MP211localreview6webdav3Xml4name(self);
    let key;
    if (_bind$3.$tag === 1) {
      const _ok = _bind$3;
      key = _ok._0;
    ...
    _M0MP211localreview6webdav3Xml5space(self);
    const _bind$4 = _M0MP211localreview6webdav3Xml4need(self, 61);
    if (_bind$4.$tag === 1) {
      const _ok = _bind$4;
      _ok._0;
    } else {
    ...
    _M0MP211localreview6webdav3Xml5space(self);
    if (self.i >= self.cs.length) {
      return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("attribute"));
    }
    const quote = _M0MPC15array5Array2atGcE(self.cs, self.i);
    if (quote !== 39 && quote !== 34) {
      return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("attribute quote"));
    }
    self.i = self.i + 1 | 0;
    const v = new _M0TPB8MutLocalGsE("");
    while (true) {
      if (self.i < self.cs.length && _M0MPC15array5Array2atGcE(self.cs, self.i) !== quote) {
        v.val = `${v.val}${_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(self.cs, self.i))}`;
        self.i = self.i + 1 | 0;
        continue;
      } else {
        break;
    ...
    const _bind$5 = _M0MP211localreview6webdav3Xml4need(self, quote);
    if (_bind$5.$tag === 1) {
      const _ok = _bind$5;
      _ok._0;
    } else {
    ...
    if (key === "xmlns") {
      const _bind$6 = _M0FP211localreview6webdav6entity(v.val);
      let _tmp;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp = _ok._0;
      ...
      _M0MPB3Map3setGssE(ns, "", _tmp);
    } else {
      const _bind$6 = "xmlns:";
      if (_M0MPC16string6String11has__prefix(key, new _M0TPC16string10StringView(_bind$6, 0, _bind$6.length))) {
        const a = _M0MPC16string6String9to__array(key);
        const _tmp = _M0MPC16string6String11from__array(_M0MPC15array5Array12view_2einnerGcE(a, 6, undefined));
        const _bind$7 = _M0FP211localreview6webdav6entity(v.val);
        let _tmp$2;
        if (_bind$7.$tag === 1) {
          const _ok = _bind$7;
          _tmp$2 = _ok._0;
        ...
        _M0MPB3Map3setGssE(ns, _tmp, _tmp$2);
      }
    }
    continue;
  }
  const _bind$3 = ":";
  const parts = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPC16string6String5split(qname, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length)));
  if (parts.length > 2) {
    return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("QName"));
  }
  const prefix = parts.length === 2 ? _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRP211localreview6webdav4NodeE(parts, 0)) : "";
  const local_name = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRP211localreview6webdav4NodeE(parts, parts.length - 1 | 0));
  let uri;
  const _bind$4 = _M0MPB3Map3getGssE(ns, prefix);
  if (_bind$4 === undefined) {
    if (_M0MPC16string6String9is__empty(prefix)) {
      uri = "";
    } else {
      return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("undeclared uri"));
    }
  } else {
    const _Some = _bind$4;
    const _v = _Some;
  ...
  const children = [];
  const content = new _M0TPB8MutLocalGsE("");
  if (_M0MPC15array5Array2atGcE(self.cs, self.i) === 47) {
    self.i = self.i + 1 | 0;
    const _bind$5 = _M0MP211localreview6webdav3Xml4need(self, 62);
    if (_bind$5.$tag === 1) {
      const _ok = _bind$5;
      _ok._0;
    } else {
    ...
    return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE2Ok(new _M0TP211localreview6webdav4Node(uri, local_name, "", children));
  }
  const _bind$5 = _M0MP211localreview6webdav3Xml4need(self, 62);
  if (_bind$5.$tag === 1) {
    const _ok = _bind$5;
  ...
  while (true) {
    if (self.i >= self.cs.length) {
      return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("unclosed element"));
    }
    if (_M0MPC15array5Array2atGcE(self.cs, self.i) === 60) {
      if ((self.i + 1 | 0) < self.cs.length && _M0MPC15array5Array2atGcE(self.cs, self.i + 1 | 0) === 47) {
        self.i = self.i + 2 | 0;
        const _bind$6 = _M0MP211localreview6webdav3Xml4name(self);
        let close;
        if (_bind$6.$tag === 1) {
          const _ok = _bind$6;
          close = _ok._0;
        ...
        if (_M0IP016_24default__implPB2Eq10not__equalGsE(close, qname)) {
          return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("mismatched tag"));
        }
        _M0MP211localreview6webdav3Xml5space(self);
        const _bind$7 = _M0MP211localreview6webdav3Xml4need(self, 62);
        if (_bind$7.$tag === 1) {
          const _ok = _bind$7;
          _ok._0;
        } else {
      ...
      const _bind$6 = _M0MP211localreview6webdav3Xml7element(self, ns, depth + 1 | 0);
      let _tmp;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp = _ok._0;
      ...
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(children, _tmp);
    } else {
      const chunk = new _M0TPB8MutLocalGsE("");
      while (true) {
        if (self.i < self.cs.length && _M0MPC15array5Array2atGcE(self.cs, self.i) !== 60) {
          chunk.val = `${chunk.val}${_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(self.cs, self.i))}`;
          self.i = self.i + 1 | 0;
          continue;
        } else {
          break;
      ...
      const _tmp = content.val;
      const _bind$6 = _M0FP211localreview6webdav6entity(chunk.val);
      let _tmp$2;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp$2 = _ok._0;
      ...
      content.val = `${_tmp}${_tmp$2}`;
    }
    continue;
  }
  return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE2Ok(new _M0TP211localreview6webdav4Node(uri, local_name, content.val, children));
}
function _M0FP211localreview6webdav8children(n, name) {
  return _M0MPC15array5Array6filterGRP211localreview6webdav4NodeE(n.children, (c) => c.ns === "DAV:" && c.name === name);
}
function _M0FP211localreview6webdav3one(n, name) {
  const xs = _M0FP211localreview6webdav8children(n, name);
  if (xs.length !== 1) {
    return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid(`expected one DAV:${name}`));
  }
  return new _M0DTPC16result6ResultGRP211localreview6webdav4NodeRP211localreview6webdav8DavErrorE2Ok(_M0MPC15array5Array2atGRP211localreview6webdav4NodeE(xs, 0));
}
function _M0FP211localreview6webdav6status(s) {
  ...
  if (pieces.length < 2) {
    ...
    let _tmp$3;
    const _tmp$4 = _M0MPC15array5Array2atGRP211localreview6webdav4NodeE(pieces, 0);
    const _bind$2 = "HTTP/1.1";
    if (_M0IP016_24default__implPB2Eq10not__equalGRPC16string10StringViewE(_tmp$4, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
      const _tmp$5 = _M0MPC15array5Array2atGRP211localreview6webdav4NodeE(pieces, 0);
      const _bind$3 = "HTTP/1.0";
      _tmp$3 = _M0IP016_24default__implPB2Eq10not__equalGRPC16string10StringViewE(_tmp$5, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length));
    } else {
      _tmp$3 = false;
    }
    _tmp$2 = _tmp$3;
  ...
  if (_tmp$2) {
    return new _M0DTPC16result6ResultGiRP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("status line"));
  }
  let n;
  let _try_err;
  _L: {
    _L$2: {
      const _bind$2 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRP211localreview6webdav4NodeE(pieces, 1));
  ...
  return new _M0DTPC16result6ResultGiRP211localreview6webdav8DavErrorE2Ok(n);
}
function _M0FP211localreview6webdav18parse__multistatus(source) {
  ...
  if (source.length > 1048576) {
    ...
    const _bind = "<!";
    _tmp = _M0MPC16string6String8contains(source, new _M0TPC16string10StringView(_bind, 0, _bind.length));
  }
  if (_tmp) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP211localreview6webdav8ResourceERP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("XML limit or unsupported DTD/comment/CDATA"));
  }
  const x = new _M0TP211localreview6webdav3Xml(_M0MPC16string6String9to__array(source), 0, 0);
  _M0MP211localreview6webdav3Xml5space(x);
  const _tmp$2 = _M0MPC16string6String11trim__start(source, undefined);
  const _bind = "<?xml";
  if (_M0MPC16string10StringView11has__prefix(_tmp$2, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    while (true) {
      if ((x.i + 1 | 0) < x.cs.length && !(_M0MPC15array5Array2atGcE(x.cs, x.i) === 63 && _M0MPC15array5Array2atGcE(x.cs, x.i + 1 | 0) === 62)) {
        x.i = x.i + 1 | 0;
        continue;
      } else {
        break;
  ...
  const _bind$2 = [];
  const _bind$3 = _M0MP211localreview6webdav3Xml7element(x, _M0MPB3Map3MapGssE(new _M0TPB9ArrayViewGUssEE(_bind$2, 0, 0), undefined), 0);
  let root;
  if (_bind$3.$tag === 1) {
    const _ok = _bind$3;
    root = _ok._0;
  ...
  _M0MP211localreview6webdav3Xml5space(x);
  if (x.i !== x.cs.length || (_M0IP016_24default__implPB2Eq10not__equalGsE(root.ns, "DAV:") || _M0IP016_24default__implPB2Eq10not__equalGsE(root.name, "multistatus"))) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP211localreview6webdav8ResourceERP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("DAV multistatus root"));
  }
  const out = [];
  const _bind$4 = _M0FP211localreview6webdav8children(root, "response");
  ...
  while (true) {
    ...
    if (_ < _bind$5) {
      const r = _bind$4[_];
      const _bind$6 = _M0FP211localreview6webdav3one(r, "href");
      let _tmp$4;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp$4 = _ok._0;
      ...
      const href = _tmp$4.text;
      const properties = [];
      const statuses = _M0FP211localreview6webdav8children(r, "status");
      if (statuses.length > 1) {
        return new _M0DTPC16result6ResultGRPB5ArrayGRP211localreview6webdav8ResourceERP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("duplicate status"));
      }
      let response_status;
      if (_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(statuses)) {
        response_status = undefined;
      } else {
        const _bind$7 = _M0FP211localreview6webdav6status(_M0MPC15array5Array2atGRP211localreview6webdav4NodeE(statuses, 0).text);
        if (_bind$7.$tag === 1) {
          const _ok = _bind$7;
      ...
      const _bind$7 = _M0FP211localreview6webdav8children(r, "propstat");
      const _bind$8 = _bind$7.length;
      let _tmp$5 = 0;
      while (true) {
        const _$2 = _tmp$5;
        if (_$2 < _bind$8) {
          const ps = _bind$7[_$2];
          ...
          const _bind$10 = _M0FP211localreview6webdav6status(_tmp$6.text);
          let code;
          if (_bind$10.$tag === 1) {
            const _ok = _bind$10;
            code = _ok._0;
          ...
          const _bind$12 = _tmp$7.children;
          const _bind$13 = _bind$12.length;
          let _tmp$8 = 0;
          while (true) {
            const _$3 = _tmp$8;
            if (_$3 < _bind$13) {
              const p = _bind$12[_$3];
              const value = p.name === "resourcetype" && !_M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(_M0FP211localreview6webdav8children(p, "collection")) ? "collection" : p.text;
              _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(properties, new _M0TP211localreview6webdav8Property(p.ns, p.name, value, code));
              _tmp$8 = _$3 + 1 | 0;
              continue;
            } else {
              break;
      ...
      if (_M0IPC16option6OptionPB2Eq5equalGiE(response_status, undefined) && _M0MPC15array5Array9is__emptyGRP211localreview6webdav4NodeE(properties)) {
        return new _M0DTPC16result6ResultGRPB5ArrayGRP211localreview6webdav8ResourceERP211localreview6webdav8DavErrorE3Err(new _M0DTPC15error5Error41localreview_2fwebdav_2eDavError_2eInvalid("response without status/properties"));
      }
      _M0MPC15array5Array4pushGRP211localreview6webdav8PropertyE(out, new _M0TP211localreview6webdav8Resource(href, response_status, properties));
      _tmp$3 = _ + 1 | 0;
      continue;
    } else {
      break;
